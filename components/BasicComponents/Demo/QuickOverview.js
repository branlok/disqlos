...
function QuickOverview() {
  ...
  const page = [
    ({ style }) => (
      <animated.div className="absolute p-10" style={{ ...style }}>
        <h1 className="text-xl sm:text-2xl lg:text-5xl font-bold">
    ...
    ({ style }) => (
      <animated.div className="absolute p-10" style={{ ...style }}>
        <h1 className="text-xl sm:text-2xl lg:text-5xl font-bold">Media</h1>
        <p className="text-sm lg:text-2xl text-gray-100">
    ...
    ({ style }) => (
      <animated.div className="absolute p-10" style={{ ...style }}>
        <h1 className="text-xl sm:text-2xl lg:text-5xl font-bold">Privately</h1>
        <p className="text-sm lg:text-2xl text-gray-100">
  ...
  return (
    <>
      ...
      <button
        className="absolute left-0 top-0 h-full w-10 flex justify-center items-center text-white  hover:bg-opacity-40 transition-all focus:outline-none"
        onClick={() => setIndex((state) => (state + 7) % 4)}
      >
        <ArrowLeft className="text-white fill-current" />
      </button>
      <button
        className="absolute right-0 top-0 h-full w-10 flex justify-center items-center text-white  hover:bg-opacity-40 transition-all focus:outline-none"
