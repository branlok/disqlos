...
function SingleComment({targetId, postId, item, page, postCachedLocation, directory }) {
  ...
  if (uid == item.uid) {
    ...
    return (
      <div className="my-1 bg-custom-pink-300 dark:bg-cb-3 rounded-sm flex flex-row justify-between items-center px-2 py-1 first:mt-0 last:mb-0 ">
        <div className="relative flex flex-col w-full ">
          <header className="flex justify-between items-center w-full border-b-2 dark:border-cb-4 pb-1 ">
            <div className="flex justify-between items-center py-2 h-full flex-col md:flex-row w-full ">
              <div className="flex-col md:flex-row flex justify-between items-center ">
                ...
                />
                <div className="text-sm font-bold text-gray-800 mx-2 dark:text-gray-300 ">
            ...
            <div
              className="absolute md:relative md:ml-2 top-0.5 right-0 flex items-center justify-center w-8 h-8 flex-initial rounded-md bg-custom-pink-500 text-gray-300 hover:bg-red-500 hover:text-red-900 cursor-pointer  dark:bg-cb-4 dark:hover:text-red-500"
    ...
    return (
      <div className="my-2 bg-custom-pink-300 dark:bg-cb-3 rounded-sm flex flex-row justify-between items-center px-2 py-1 first:mt-0 last:mb-0">
          ...
          <header className="flex justify-between items-center w-full border-b-2  dark:border-cb-4  pb-1 ">
            <div className="flex justify-between items-center  h-full">
              <img
                ...
                src={primaryProfileImage}
              ></img>
              <div className="ml-2 text-sm font-bold text-gray-800 dark:text-gray-300">
                {item.uniqueDisplayName}
              </div>
            </div>
          </header>
