...
function ProfileNav({ directive }) {
  return (
    <div className="w-full h-14 bg-gradient-to-r from-indigo-600 to-purple-700  dark:to-indigo-700 dark:from-purple-700  text-white  rounded-lg dark:bg-cb-4 dark:text-white flex flex-between items-center font-bold">
      <div
      ...
      <ul className="h-full w-full flex justify-end items-center">
        <li
          className={` flex justify-center border-b-4 border-transparent items-center h-full px-4 mx-2   hover:animate-pulse transition-all  ${
            directive == "dashboardPosts" && "  border-white dark:border-gray-300 "
          } `}
        >
